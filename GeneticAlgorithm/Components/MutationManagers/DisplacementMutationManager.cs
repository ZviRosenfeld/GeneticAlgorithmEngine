...
{
    /// <summary>
    /// Removes a stretch of genomes from the chromosome, and inserts them in a new location.
    ...
    /// This would result in the chromosome 1 3 4 5 2 6 7.
    /// 
    ...
    /// </summary>
    public class DisplacementMutationManager<T> : IMutationManager<T>
    {
        private readonly DisplacementMutationBase<T> displacementMutationBase = new DisplacementMutationBase<T>(false);
